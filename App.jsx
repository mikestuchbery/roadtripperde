...
async function geocode(place) {
  ...
  // --- Attempt 1: Photon (Komoot) — permissive CORS, works on desktop & mobile ---
  try {
    ...
    // Prefer German results to avoid matching cities in other countries
  ...
  // Nominatim blocks requests without a User-Agent header on desktop browsers
  // (browsers can't set that header via fetch), so Photon is always tried first.
  try {
